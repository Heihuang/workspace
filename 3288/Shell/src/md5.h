...
BASE_EXPORT void MD5Update(MD5Context* context, const void* data, size_t length);
...
BASE_EXPORT void MD5IntermediateFinal(MD5Digest* digest, const MD5Context* context);
...
BASE_EXPORT std::string MD5File(const wchar_t* file);
